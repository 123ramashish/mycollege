...
export default function AdminDrawer() {
  ...
  return (
    <>
      <div className="bg-black w-full absolute top-0 left-0 z-50 mb-12 overflow-hidden">
        <Button onClick={() => setIsOpen(true)} className="ml-12 my-2"><IoMdMenu className="text-white text-2xl"/></Button>
